    ...
    <div>
      ...
      <div className="grid grid-cols-12 gap-14">
        <div className="col-span-8">
          ...
          <div className="">
            {/* CART1 */}
            <div className="flex items-center justify-between border-b border-slate-400 text-slate-400 pb-3 text-sm mb-4">
        ...
        <div className="col-span-4 sm:block bg-white border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-700 text-slate-800 overflow-hidden hidden p-5 dark:text-slate-100 font-bold">
          ...
          <p className="border-b border-slate-500 pb-6 text-slate-400 font-normal">We only change for shipping when you have over 2kg items</p>
