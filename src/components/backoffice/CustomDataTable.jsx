        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg p-8">
          ...
          >
            <span className="text-xl font-normal text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">
              ...
              of{" "}
              <span className="font-semibold text-gray-880 dark:text-white">
                {data.length}
              </span>
            </span>
                ...
                return (
                  <li key={index}>
                    <button
                      ...
                      className={
                        currentPage == index + 1 ? "flex items-center justify-center px-3 h-10 leading-tight text-gray-50 bg-blue-600 border border-blue-300 hover:bg-blue-800 hover:text-white dark:bg-slate-300 dark:border-slate-400 dark:text-slate-800 dark:hover:bg-slate-300"
